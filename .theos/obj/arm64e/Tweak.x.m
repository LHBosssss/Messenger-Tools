...
@class LSComposerViewController; @class LSMessageListViewController; @class LSStoryBucketViewController; 
...
static void (*_logos_orig$disableTypingIndicator$LSComposerViewController$_updateComposerEventWithTextViewChanged$)(_LOGOS_SELF_TYPE_NORMAL LSComposerViewController* _LOGOS_SELF_CONST, SEL, id); static void _logos_method$disableTypingIndicator$LSComposerViewController$_updateComposerEventWithTextViewChanged$(_LOGOS_SELF_TYPE_NORMAL LSComposerViewController* _LOGOS_SELF_CONST, SEL, id); 
	...
	@end
		...
		static void _logos_method$disableTypingIndicator$LSComposerViewController$_updateComposerEventWithTextViewChanged$(_LOGOS_SELF_TYPE_NORMAL LSComposerViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1) {
